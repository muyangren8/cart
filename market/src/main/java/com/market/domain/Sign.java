...
public class Sign implements Serializable {
    ...
    private Integer aPlanNum;
    private Integer bPlanNum;
    private Integer cPlanNum;
    ...
    public Integer getaPlanNum() {
        return aPlanNum;
    }

    public void setaPlanNum(Integer aPlanNum) {
        this.aPlanNum = aPlanNum;
    }
    ...
    public Integer getcPlanNum() {
        return cPlanNum;
    }

    public void setcPlanNum(Integer cPlanNum) {
    ...
    public String toString() {
        return "Sign{" + "id=" + id + ", mid=" + mid + ", mname='" + mname + '\'' + ", gid=" + gid + ", gname='" + gname + '\'' + ", cid=" + cid + ", cname='" + cname + '\'' + ", aPlanNum=" + aPlanNum + ", bPlanNum=" + bPlanNum + ", cPlanNum=" + cPlanNum + ", planStartDate=" + planStartDate + ", planEndDate=" + planEndDate + ", signatureImageA='" + signatureImageA + '\'' + ", signatureImageB='" + signatureImageB + '\'' + ", imageA=" + Arrays.toString(imageA) + ", imageB=" + Arrays.toString(imageB) + ", signDateA=" + signDateA + ", signDateB=" + signDateB + '}';
    }
}
